...
import 'package:flt_provider/core/viewmodels/comments_model.dart';
import 'package:flt_provider/ui/shared/app_colors.dart';
import 'package:flt_provider/ui/shared/ui_helper.dart';
import 'package:flt_provider/ui/views/base_view.dart';
    ...
    return BaseView<CommentsModel>(
      ...
      builder: (context, model, child) {
        ...
        Expanded(child: ListView(
          children: model.comments.map((comment) => CommentItem(comment))
              .toList(),
        ),);
      },
    );
